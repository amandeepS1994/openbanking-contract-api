...
import com.abidevel.openbanking.banking.model.OBReadDirectDebit2;
...
@Api(value = "direct-debits", description = "the direct-debits API")
public interface DirectDebitsApi {
     ...
     */
    @ApiOperation(value = "Get Direct Debits", nickname = "getDirectDebits", notes = "", response = OBReadDirectDebit2.class, authorizations = {
